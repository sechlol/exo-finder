...
class TestParallelExecution:
    ...
    def test_sequence_single_and_batch_simple(self, task_profile, batch_size, show_combined_progress):
    ...
    def test_large_n_jobs_forces_combined_progress_and_logs_warning(self, caplog):
    ...
    def test_sequence_single_callable_on_thread_backend_with_batching(self):
